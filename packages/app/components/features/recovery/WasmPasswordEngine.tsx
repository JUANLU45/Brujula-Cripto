  ...
  return (
    <div className="mx-auto max-w-4xl p-6">
      <div className="rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({ ...prev, partialPassword: e.target.value }))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({ ...prev, passwordLength: e.target.value }))
                  }
        ...
        {recoveryState.stage === 'processing' && (
          <div className="space-y-6">
