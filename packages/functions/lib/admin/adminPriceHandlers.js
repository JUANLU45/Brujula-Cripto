...
exports.updatePricingConfig = (0, https_1.onCall)(async (request) => {
    try {
        ...
        const updatedConfig = {
            firstTwoHours: Object.assign(Object.assign({}, currentConfig.firstTwoHours), { price: firstTwoHoursPrice !== undefined
                    ? firstTwoHoursPrice
                    : currentConfig.firstTwoHours.price }),
            additionalHours: Object.assign(Object.assign({}, currentConfig.additionalHours), { price: additionalHoursPrice !== undefined
